...
@Singleton
@Component(modules = [MainActivityPresenterModule::class,RetrofitModule::class]) //tell the dagger to generate code with all dependencies it's called whenever you want to inject app graph in the activity
